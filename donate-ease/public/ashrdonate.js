...
const ashform=document.getElementById("ashrdonation");

ashform.addEventListener("submit",function(event){
  event.preventDefault();
  const name=ashform.donorname.value;
   const mobilenumber=ashform.donormobile.value;
    const address=ashform.donoraddress.value;
    const selecttag=ashform.donationtype.value;
    const      donationdetails=ashform.donationdetails.value;
    const auth = getAuth();
